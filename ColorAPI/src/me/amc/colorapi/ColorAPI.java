...
public class ColorAPI {
	...
	public void addColor(ItemStack item, Colors color){
		...
		if(material == Material.WOOL || material == Material.STAINED_GLASS || material == Material.STAINED_GLASS_PANE || material == Material.STAINED_CLAY){
